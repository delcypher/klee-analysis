def __fail_generator(spec: "A failure specification", failures: "An iterable list of failures"):
	if failures is None:
		return []
	allowed_failures = {}
...
TASKS = {
	...
	"no_integer_division_by_zero": lambda spec, kleedir: __fail_generator(spec, kleedir.division_failures),
	"no_invalid_deref": lambda spec, kleedir: __fail_generator(spec, kleedir.ptr_errors),
	"no_invalid_free": lambda spec, kleedir: __fail_generator(spec, kleedir.free_errors),
	"no_overshift": lambda spec, kleedir: __fail_generator(spec, kleedir.overshifts),
	"no_reach_error_function": lambda spec, kleedir: __fail_generator(spec, kleedir.abortions)
}
